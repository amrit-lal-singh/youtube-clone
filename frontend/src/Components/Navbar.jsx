    ...
    <>
      <div className={theme === true ? "navbar" : "navbar light-mode"}>
        ...
        >
          ...
          <button onClick={() => { if (isbtnClicked === false) { setisbtnClicked(true); document.body.classList.add("bg-css"); mixpanel.track('signin_clicked', { 'theme': theme ? 'Dark' : 'Light', 'user_status': User.success ? 'Logged In' : 'Logged Out' }); } else { setisbtnClicked(false); document.body.classList.remove("bg-css"); } }} className={theme ? "signin" : "signin signin-light"} style={ User.success ? { display: "none", } : { display: "flex", } } >
